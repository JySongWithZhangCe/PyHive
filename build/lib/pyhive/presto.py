...
class Cursor(common.DBAPICursor):
    ...
    def __init__(self, host, port='8080', username=None, principal_username=None, catalog='hive',
                 schema='default', client_tags=None, poll_interval=1, source='pyhive', session_props=None,
        ...
        :param client_tags: list -- defaults to ``None``
    ...
    def execute(self, operation, parameters=None):
        ...
        headers = {
            ...
            'X-Presto-Client-Tags': self._client_tags,
